...
const SettingsCard = ({ title, description, children, footer }) => (
  <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/80 rounded-2xl">
    ...
    <div className="divide-y divide-slate-700/80">{children}</div>
    {footer && (
    ...
    <div className="space-y-8 animate-fadeIn py-8 px-18">
      ...
      <div>
        ...
        <p className="text-slate-400 mt-1">
          Manage how you receive notifications from PitchPort.
        </p>
      </div>
      ...
      <SettingsCard
        ...
        footer={
          <button2
            type="button"
            className="bg-cyan-400 hover:bg-cyan-300 text-slate-900 font-bold px-6 py-2.5 rounded-lg shadow-md transition-colors cursor-pointer"
          >
            Save Preferences
          </button2>
        }
      ...
      <SettingsCard title="General Notifications">
        <NotificationSetting
          icon={<Bell />}
